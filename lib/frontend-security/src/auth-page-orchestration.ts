...
export function useLoginRoutePolicy(options: {
  ...
  const metadataError = metadataResolutionError
    ? metadataResolutionDiagnostic.message
      ? formatAuthMessage("auth_error_metadata_unavailable_with_detail", {
          reason: metadataResolutionError,
          detail: metadataResolutionDiagnostic.message,
        })
      : formatAuthMessage("auth_error_metadata_unavailable", {
          reason: metadataResolutionError,
        })
    : null;
