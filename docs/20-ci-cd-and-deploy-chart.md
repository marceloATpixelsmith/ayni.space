...
| `.github/workflows/codex-safe-auto-merge.yml` | Keep PRs fresh and enable native GitHub auto-merge for in-repo PRs | Pull request target events on `master`-targeting PR updates | Merge automation only; no environment deploy |
