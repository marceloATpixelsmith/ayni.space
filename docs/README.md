...
10. `tenant-isolation-and-data-ownership-inventory.md`
11. `tenant-isolation-and-data-ownership.md`
12. `dependency-lockfile-and-build-inventory.md`
13. `dependency-and-lockfile-rules.md`
14. `api-and-backend-architecture.md`
15. `ci-cd-and-deploy-inventory.md`
16. `ci-cd-and-deploy-rules.md`
17. `ci-cd-and-deploy-chart.md`
18. `observability-error-handling-and-sentry-inventory.md`
19. `observability-error-handling-and-sentry.md`
20. `shared-systems-inventory.md`
21. `security-standards-and-non-negotiables.md`
22. `security-backup-and-restore.md`
23. `security-incident-response.md`
24. `security-restore-drill-log.md`
25. `security-baseline-status.md`
26. `security-inventory-current-state.md`
27. `file-and-folder-ownership.md`
28. `codex-working-rules.md`
29. `open-questions-and-conflicts.md`
30. `auth-security-regression-suite.md`
