...
| `.github/workflows/codex-safe-auto-merge.yml` | Safe auto-merge for in-repo pull requests after checks pass | Pull request events on `master`-targeting PR updates | Merge automation only; no environment deploy |
