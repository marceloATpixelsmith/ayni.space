...
- Active first-class code locations:
  ...
  - `frontend` (standalone Next.js app, not in workspace)
...
- The monorepo currently mixes **active**, **placeholder**, and **prototype** surfaces (e.g., Next.js `frontend` app vs Vite `apps/admin`).

## Unclear / requires confirmation
- Whether `frontend/` is planned replacement, parallel product, or abandoned scaffold.
