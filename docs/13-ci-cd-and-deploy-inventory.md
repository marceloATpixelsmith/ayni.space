...
- Workflow: `.github/workflows/codex-pr-hygiene.yml` ensures new PR branches originate from latest `master` and flags stale/stacked branch ancestry on PR open.
