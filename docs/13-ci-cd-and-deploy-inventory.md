...
- Workflow: `.github/workflows/codex-safe-auto-merge.yml` waits for required checks and merges in-repo PRs into `master` with normal merge behavior (no force-reset/push).
