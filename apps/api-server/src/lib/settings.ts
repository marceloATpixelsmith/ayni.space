...
export const GLOBAL_NON_SECRET_RUNTIME_SETTING_KEYS = [
  GLOBAL_SETTING_KEYS.SENTRY_DSN,
  GLOBAL_SETTING_KEYS.SENTRY_ENVIRONMENT,
  GLOBAL_SETTING_KEYS.GOOGLE_REDIRECT_URI,
  GLOBAL_SETTING_KEYS.TURNSTILE_ENABLED,
  GLOBAL_SETTING_KEYS.IPQS_BLOCK_THRESHOLD,
  GLOBAL_SETTING_KEYS.IPQS_STEP_UP_THRESHOLD,
  GLOBAL_SETTING_KEYS.IPQS_TIMEOUT_MS,
  GLOBAL_SETTING_KEYS.OPENAI_MAX_RETRIES,
  GLOBAL_SETTING_KEYS.OPENAI_MODEL,
  GLOBAL_SETTING_KEYS.OPENAI_TEMPERATURE,
  GLOBAL_SETTING_KEYS.OPENAI_TIMEOUT_MS,
] as const;
